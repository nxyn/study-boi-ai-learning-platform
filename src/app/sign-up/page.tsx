  ...
  return (
    <div className="min-h-screen bg-background relative overflow-hidden flex items-center justify-center p-6">
      ...
      <div className="fixed inset-0 pointer-events-none">
        ...
        <div className="absolute top-1/4 right-1/4 w-[700px] h-[700px] bg-gradient-to-br from-purple-500/30 via-purple-600/15 to-transparent rounded-full blur-[128px] animate-[float_20s_ease-in-out_infinite]" />
        <div className="absolute bottom-1/4 left-1/4 w-[600px] h-[600px] bg-gradient-to-br from-blue-500/25 via-indigo-500/15 to-transparent rounded-full blur-[100px] animate-[float_25s_ease-in-out_infinite_reverse]" />
      ...
      <Card className="relative w-full max-w-md border-2 border-purple-400/40 bg-gradient-to-br from-black/70 via-purple-950/40 to-black/70 backdrop-blur-2xl rounded-3xl shadow-[0_20px_80px_rgba(139,92,246,0.6)] z-10 overflow-hidden animate-[fadeInUp_0.8s_ease-out]">
        ...
        <CardHeader className="relative text-center space-y-4 pt-10">
          ...
          <CardTitle className="text-4xl font-black bg-gradient-to-b from-white to-purple-200 bg-clip-text text-transparent drop-shadow-xl animate-[fadeInUp_0.8s_ease-out_0.3s_both]">Create Account</CardTitle>
          <p className="text-lg text-purple-200/80 font-medium animate-[fadeInUp_0.8s_ease-out_0.4s_both]">Start your learning journey today!</p>
        </CardHeader>
        <CardContent className="relative pt-6 pb-10">
          <form onSubmit={handleSubmit} className="space-y-5">
            <div className="space-y-3">
              <Label htmlFor="name" className="text-purple-200/90 font-semibold text-base">Full Name</Label>
              <Input
                id="name"
                type="text"
            ...
            <div className="space-y-3">
              ...
              <Input
                ...
                className="h-12 bg-black/40 border-2 border-purple-400/30 focus:border-purple-400/60 rounded-xl text-base backdrop-blur-xl transition-all duration-300 focus:scale-[1.02]"
              />
              <p className="text-sm text-purple-300/70 font-medium">Must be at least 8 characters</p>
            </div>
            <div className="space-y-3">
              <Label htmlFor="confirmPassword" className="text-purple-200/90 font-semibold text-base">Confirm Password</Label>
              <Input
                id="confirmPassword"
                type="password"
                placeholder="••••••••"
            ...
            <Button
              type="submit"
              className="relative group w-full h-14 bg-gradient-to-r from-purple-600 via-purple-500 to-purple-700 hover:from-purple-700 hover:via-purple-600 hover:to-purple-800 text-lg font-bold shadow-xl shadow-purple-500/50 border-2 border-purple-400/30 transition-all duration-300 hover:scale-105 rounded-xl mt-6 hover:-translate-y-1"
              disabled={isLoading}
            >
              {isLoading ? (
                <>
          ...
          <div className="mt-8 text-center text-base">
            <p className="text-purple-200/70 font-medium">
              ...
              <Link href="/sign-in" className="text-purple-300 hover:text-purple-200 underline underline-offset-4 font-bold transition-all duration-300 hover:scale-105 inline-block">
                Sign in
              </Link>
            </p>
          </div>
